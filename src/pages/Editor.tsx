          ...
          {activeTabId ? (
            ...
            <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
              <div className="text-center max-w-xl mx-auto px-6">
                <div className="mb-6">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-xl flex items-center justify-center shadow-md" style={{ background: `linear-gradient(to bottom right, var(--accent-color), hsl(var(--accent-h), var(--accent-s), calc(var(--accent-l) - 5%)))` }}>
                    <img 
                      src="/app-icon.png" 
                      alt="GoPilot" 
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                  <button
                    onClick={handleOpenFolder}
                    className="group flex flex-col items-center justify-center p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-all hover:shadow-md"
                    onMouseEnter={(e) => {
                  ...
                  >
                    <div className="w-10 h-10 mb-2 rounded-md flex items-center justify-center transition-colors" style={{ backgroundColor: 'var(--accent-color)', opacity: 0.1 }}>
                    ...
                    <div className="space-y-1">
                      {recentFiles.slice(0, 5).map((file, index) => (
                        <div
                          ...
                          className="group w-full flex items-center gap-2 px-3 py-2 text-left bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 hover:shadow-sm transition-all cursor-pointer"
                          onMouseEnter={(e) => {
                            e.currentTarget.style.borderColor = 'var(--accent-color)';
                          }}
                          onMouseLeave={(e) => {
                        ...
                        >
                          <div className="flex-shrink-0 w-6 h-6 rounded flex items-center justify-center transition-colors" style={{ backgroundColor: 'var(--accent-color)', opacity: 0.1 }}>
